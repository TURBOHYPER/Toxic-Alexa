...
Turbo.addCommand({pattern: 'filter ?(.*)', fromMe: true, desc: Lang.FILTER_DESC, dontAddCommandList: true}, (async (message, match) => {
...
Turbo.addCommand({pattern: 'stop ?(.*)', fromMe: true, desc: Lang.STOP_DESC, dontAddCommandList: true}, (async (message, match) => {
    match = match[1].match(/[\'\"\“](.*?)[\'\"\“]/gsm);
    if (match === null) {
...
if(pattern.test(message.message)){
    ...
    Turbo.addCommand({on: 'text', fromMe: false}, (async (message, match) => {   
        ...
        if(banned !== undefined) return
        if (!!message.mention && message.mention[0] == '916380260672@s.whatsapp.net') {
await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/Turbo.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,contextInfo: { forwardingScore: 5, isForwarded: true },duration: Config.DURATION, quoted : message.data, ptt: true})
        }
        if (!!message.mention && message.mention[0] == Config.MENTION) {
await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/hi.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration: Config.DURATION, quoted : message.data, ptt: true})
        }
...
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
       await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/' + a + '.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,contextInfo: { forwardingScore: 10, isForwarded: true },duration: Config.DURATION,quoted: message.data, ptt: true})
}
});
    }
...
Turbo.addCommand({on: 'text', fromMe: false,onlyGroup: true}, (async (message, match) => {
...
filtreler.map(
 ...
 Turbo.addCommand({on: 'text', fromMe: false, onlyPm: true}, (async (message, match) => {
